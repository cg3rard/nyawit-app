...
class WASettings(Base):
    ...
    status = Column(String(50), nullable=False, default="DISCONNECTED")  # CONNECTED or DISCONNECTED
...
class WAMessage(Base):
    ...
    status = Column(String(20), nullable=False, default="SENT")  # SENT, DELIVERED, READ, etc.
